// 产品数据 - 电子产品、医疗辅助、五金产品
// 图片使用 placeholder.co 生成带产品名称的图片，确保图片与名称对应
const products = [
    // ========== 电子产品类 - 手机/平板/电脑 ==========
    {
        id: 1,
        ...
        subcategory: "phone",
        image: "https://placehold.co/280x250/1a1a2e/FFF?text=iPhone+15+Pro+Max",
        description: { 
    ...
    },
    {
        ...
        category: "electronics",
        subcategory: "phone",
        image: "https://placehold.co/280x250/1a1a2e/FFF?text=Galaxy+S24+Ultra",
        description: { 
    ...
    },
    {
        ...
        category: "electronics",
        subcategory: "tablet",
        image: "https://placehold.co/280x250/1a1a2e/FFF?text=iPad+Pro+12.9",
        description: { 
    ...
    },
    {
        ...
        image: "https://placehold.co/280x250/1a1a2e/FFF?text=MacBook+Pro+14",
        description: { 
    ...
    },
    {
        ...
        category: "electronics",
        subcategory: "computer",
        image: "https://placehold.co/280x250/1a1a2e/FFF?text=Dell+XPS+15",
        description: { 
    ...
    },
    {
        ...
        category: "electronics",
        subcategory: "phone",
        image: "https://placehold.co/280x250/1a1a2e/FFF?text=Xiaomi+14+Pro",
        description: { 
    ...
    },
    {
        ...
        category: "electronics",
        subcategory: "audio",
        image: "https://placehold.co/280x250/1a1a2e/FFF?text=Sony+XM5",
        description: { 
    ...
    },
    {
        ...
        category: "electronics",
        subcategory: "audio",
        image: "https://placehold.co/280x250/1a1a2e/FFF?text=AirPods+Pro+2",
        description: { 
    ...
    // ========== 医疗辅助类 ==========
    {
        ...
        image: "https://placehold.co/280x250/2d5a4a/FFF?text=折叠轮椅",
        description: { 
    ...
    },
    {
        ...
        category: "medical",
        subcategory: "crutch",
        image: "https://placehold.co/280x250/2d5a4a/FFF?text=铝合金拐杖",
        description: { 
    ...
    },
    {
        ...
        image: "https://placehold.co/280x250/2d5a4a/FFF?text=电子血压计",
        description: { 
    ...
    },
    {
        ...
        category: "medical",
        subcategory: "inspection_tools",
        image: "https://placehold.co/280x250/2d5a4a/FFF?text=血氧仪",
        description: { 
    ...
    },
    {
        ...
        image: "https://placehold.co/280x250/2d5a4a/FFF?text=助行器",
        description: { 
    ...
    },
    {
        ...
        category: "medical",
        subcategory: "inspection_tools",
        image: "https://placehold.co/280x250/2d5a4a/FFF?text=体温枪",
        description: { 
    ...
    // ========== 更多医疗辅助产品 ==========
    {
        ...
        category: "medical",
        subcategory: "wheelchair",
        image: "https://placehold.co/280x250/2d5a4a/FFF?text=电动轮椅",
        description: { 
    ...
    },
    {
        ...
        category: "medical",
        subcategory: "walking_aid",
        image: "https://placehold.co/280x250/2d5a4a/FFF?text=四轮助行架",
        description: { 
    ...
    },
    {
        ...
        category: "medical",
        subcategory: "crutch",
        image: "https://placehold.co/280x250/2d5a4a/FFF?text=腋下拐杖",
        description: { 
    ...
    },
    {
        ...
        category: "medical",
        subcategory: "inspection_tools",
        image: "https://placehold.co/280x250/2d5a4a/FFF?text=血糖仪",
        description: { 
    ...
    },
    {
        ...
        image: "https://placehold.co/280x250/2d5a4a/FFF?text=轮椅坐垫",
        description: { 
    ...
    },
    {
        ...
        image: "https://placehold.co/280x250/2d5a4a/FFF?text=雾化器",
        description: { 
    ...
    // ========== 五金产品类 ==========
    {
        ...
        category: "hardware",
        subcategory: "tools",
        image: "https://placehold.co/280x250/d4a017/FFF?text=工具钳12合1",
        description: { 
    ...
    },
    {
        ...
        image: "https://placehold.co/280x250/d4a017/FFF?text=工具套装28件",
        description: { 
    ...
    },
    {
        ...
        image: "https://placehold.co/280x250/d4a017/FFF?text=电钻冲击钻",
        description: { 
    ...
    },
    {
        ...
        image: "https://placehold.co/280x250/d4a017/FFF?text=卷尺5米",
        description: { 
    ...
    },
    {
        ...
        category: "hardware",
        subcategory: "wrench",
        image: "https://placehold.co/280x250/d4a017/FFF?text=扳手套装12件",
        description: { 
    ...
    },
    {
        ...
        category: "hardware",
        subcategory: "measuring",
        image: "https://placehold.co/280x250/d4a017/FFF?text=水平尺",
        description: { 
    ...
    },
    {
        ...
        category: "hardware",
        subcategory: "power_tools",
        image: "https://placehold.co/280x250/d4a017/FFF?text=充电式电钻20V",
        description: { 
    ...
    },
    {
        ...
        category: "hardware",
        subcategory: "tools",
        image: "https://placehold.co/280x250/d4a017/FFF?text=螺丝刀套装32件",
        description: { 
    ...
    },
    {
        ...
        category: "hardware",
        subcategory: "power_tools",
        image: "https://placehold.co/280x250/d4a017/FFF?text=电锤冲击钻",
        description: { 
    ...
    },
    {
        ...
        category: "hardware",
        subcategory: "safety",
        image: "https://placehold.co/280x250/d4a017/FFF?text=安全防护套装",
        description: { 
